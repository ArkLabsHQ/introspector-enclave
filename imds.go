...
// This mirrors the Python implementation in imds.py.
...
// This is used inside enclaves where viproxy provides IMDS access at 127.0.0.1:80.
func loadAWSConfigWithIMDS(ctx context.Context) (aws.Config, error) {
	// First try to fetch credentials from IMDS via viproxy
